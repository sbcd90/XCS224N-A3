...
\item \points{2quiz} Please input answer to question 2 of the Gradescope online assessment |A3 Online Assessment|.
...
\item Please input answer to question 3.1 - 3.2 of the Gradescope online assessment |A3 Online Assessment|.
...
\item \points{3aquiz} What must $\gamma$ equal in terms of $p_\text{drop}$?
...
\item \points{3bquiz} Which among the below options are correct regarding dropout at train and test time?
...
\item \points{4aquiz} Select the right option for blanks (i) and (ii):
...
\item \points{4bquiz} Select the right option for blanks (iii) and (iv):
...
\item \points{4cquiz} Select the right option for blanks (v) and (vi):
...
\item \points{4dquiz} Select the right option for blanks (vii) and (viii):
...
\item \points{4equiz} Select the right option for blanks (ix) and (x):
...
\item \points{5quiz} Please input answer to question 5 of the Gradescope online assessment |A3 Online Assessment|.
...
\item \points{6quiz} Please input answer to question 6 of the Gradescope online assessment |A3 Online Assessment|.
...
\item \points{7quiz} Please input answer to question 7 of the Gradescope online assessment |A3 Online Assessment|.
...
\item \points{8quiz} Please input answer to question 8 of the Gradescope online assessment |A3 Online Assessment|.
...
\item \points{9quiz} Please input answer to question 9 of the Gradescope online assessment |A3 Online Assessment|.
